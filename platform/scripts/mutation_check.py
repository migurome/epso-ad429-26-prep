...
MUTATIONS = [
    ...
    (
        "entrar con otra cuenta conserva lo recordado de la anterior",
    ...
    (
        "salir deja apuntada la fila de la cuenta que se acaba de ir",
        "src/lib/syncStore.ts",
        "        set({ status: 'signed-out', error: null, email: null, sync: {}, lastSyncAt: null }),",
        "        set({ status: 'signed-out', error: null, email: null }),",
        "src/components/SyncCard.test.tsx",
    ),
    (
        "un fallo al guardar echa al candidato de la sesión",
