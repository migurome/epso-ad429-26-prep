    ...
    <div>
      <PageHeader
        ...
        description={`${field.posts} ${locale === 'es' ? 'plazas en la lista de reserva para este campo.' : 'posts on the reserve list for this field.'}${
          field.id === USER_FIELD ? ` ${t('your_field_chosen_suffix')}` : ''
        }`}
      />
      ...
      <Tabs
        tabs={[
          ...
          },
          {
            ...
            content:
              questions.length === 0 ? (
                <EmptyState icon={<ClipboardList size={28} />} title={t('empty_bank_title')} description={t('empty_field_bank_description')} />
              ) : (
